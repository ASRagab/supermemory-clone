...
describe('CSRF Token Endpoint', () => {
  ...
  beforeEach(() => {
    ...
    app.get('/csrf-token', (c) => {
      ...
      // Set cookie
      c.header('Set-Cookie', `csrf-token=${tokenString}; HttpOnly; Secure; SameSite=Strict; Path=/`)
...
describe('Token Rotation', () => {
  ...
  beforeEach(() => {
    ...
    app.post('/auth/login', (c) => {
      ...
      c.header('Set-Cookie', `csrf-token=${tokenString}; HttpOnly; Secure; SameSite=Strict`)
...
describe('Cookie Security Settings', () => {
  ...
  beforeEach(() => {
    ...
    app.get('/set-csrf', (c) => {
      ...
      c.header('Set-Cookie', `csrf-token=${tokenString}; HttpOnly; Secure; SameSite=Strict; Path=/; Max-Age=3600`)
