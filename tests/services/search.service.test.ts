...
describe('SearchService', () => {
  ...
  describe('hybridSearch', () => {
    ...
    it('should return total count of results', async () => {
      const memories = Array.from({ length: 20 }, (_, i) =>
        createMockMemory(`Memory ${i} about testing.`, `mem${i}`)
      );
  ...
  describe('metadata filters', () => {
    ...
    it('should filter by contains operator', async () => {
      ...
      const filters: MetadataFilter[] = [
        { key: 'category', value: 'frontend', operator: 'contains' },
      ];
  ...
  describe('getStats', () => {
    it('should return vector and memory counts', async () => {
      const memories = [
        createMockMemory('Memory 1.', 'mem1'),
        createMockMemory('Memory 2.', 'mem2'),
      ];
