...
describe('MemoryRepository', () => {
  ...
  it('should reject empty containerTag on update', async () => {
    ...
    await expect(repository.update(memory.id, { containerTag: '' })).rejects.toBeInstanceOf(ValidationError)
  })
  ...
  describe('semanticSearch', () => {
    ...
    it('should enforce similarityThreshold when embeddings are enabled', async () => {
      ...
      const { createMemoryRepository: createRepo, resetMemoryRepository: resetRepo } =
