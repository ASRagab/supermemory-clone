...
describe('Type Guards', () => {
  ...
  describe('isRetryableError', () => {
    ...
    it('should return true for InternalServerError', () => {
      expect(isRetryableError(new InternalServerError(500, {}, 'Server error', undefined))).toBe(true)
    })
    ...
    it('should return false for AuthenticationError', () => {
      expect(isRetryableError(new AuthenticationError(401, {}, 'Unauthorized', undefined))).toBe(false)
    })
