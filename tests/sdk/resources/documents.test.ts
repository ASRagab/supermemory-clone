...
describe('Documents Resource', () => {
  ...
  describe('get()', () => {
    ...
    it('should URL-encode document ID', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/v3/documents/doc%2Fspecial'), expect.any(Object))
    })
  })
  ...
  describe('list()', () => {
    ...
    it('should include filter parameters', async () => {
      mockFetch.mockResolvedValueOnce(new Response(JSON.stringify({ documents: [], pagination: {} })))
  ...
  describe('add()', () => {
    it('should add document via POST to /v3/add', async () => {
      mockFetch.mockResolvedValueOnce(new Response(JSON.stringify({ id: 'doc-new', status: 'processing' })))
  ...
  describe('update()', () => {
    ...
    it('should handle null body', async () => {
      mockFetch.mockResolvedValueOnce(new Response(JSON.stringify({ id: 'doc-123', status: 'ready' })))
    ...
    it('should URL-encode document ID', async () => {
      mockFetch.mockResolvedValueOnce(new Response(JSON.stringify({ id: 'doc/special', status: 'ready' })))
  ...
  describe('uploadFile()', () => {
    it('should upload file via multipart form', async () => {
      mockFetch.mockResolvedValueOnce(new Response(JSON.stringify({ id: 'doc-upload', status: 'processing' })))
