...
describe('Connections Resource', () => {
  ...
  describe('create()', () => {
    ...
    it('should URL-encode provider name', async () => {
      mockFetch.mockResolvedValueOnce(new Response(JSON.stringify({ id: 'conn-123', authLink: '', expiresIn: 3600 })))
  ...
  describe('configure()', () => {
    it('should configure connection resources', async () => {
      mockFetch.mockResolvedValueOnce(new Response(JSON.stringify({ id: 'conn-123', configured: true })))
  ...
  describe('deleteByID()', () => {
    it('should delete connection by ID', async () => {
      mockFetch.mockResolvedValueOnce(new Response(JSON.stringify({ id: 'conn-123', provider: 'github' })))
  ...
  describe('resources()', () => {
    ...
    it('should include pagination parameters', async () => {
      mockFetch.mockResolvedValueOnce(new Response(JSON.stringify({ resources: [], total_count: 0 })))
